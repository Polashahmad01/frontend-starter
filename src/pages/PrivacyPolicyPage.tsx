  ...
  return (
    <article>
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        At FrontEnd Starter, accessible from https://frontendstarter.com, one of
        ...
        FrontEnd Starter and how we use it.
      </p>
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        ...
        shared and/or collect in FrontEnd Starter. This policy is not applicable
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        FrontEnd Starter follows a standard procedure of using log files. These
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        Like any other website, FrontEnd Starter uses &quot;cookies&quot;. These
      ...
      <h2 className="text-xl font-bold mb-4 opacity-80 lg:w-10/12">
        Advertising Partners Privacy Policiess
      </h2>
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        You may consult this list to find the Privacy Policy for each of the
        advertising partners of FrontEnd Starter.
      </p>
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on FrontEnd Starter, which are sent
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        Note that FrontEnd Starter has no access to or control over these
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        FrontEnd Starter&apos;s Privacy Policy does not apply to other
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 lg:w-10/12">
        FrontEnd Starter does not knowingly collect any Personal Identifiable
      ...
      <p className="text-sm font-light leading-6 opacity-80 mb-4 pb-6 lg:w-10/12">
